...
save(RCP45_Occ_map, file = "C:/Users/2022207/Dropbox/Jack's PhD/Chapter 3. Future shark FD/Analyses/Final paper R codes/data/AquaMaps/FD_RCP45_Species_richness_map.RData")
...
pcoa <- list(li = sp_faxes_coord_sharksRCP45)
...
test <- apply(baskets_sharks_weightsRCP45, 1, function(x) {
...
FDindices_taxon_RCP45_FD <- data.frame(
  Grid = grid_names, 
  sp_richn = sp_richn,
  fric = fric,
  fsp = fsp,
...
# Save dataframe
save(FDindices_taxon_RCP45_FD, file = "C:/Users/2022207/Dropbox/Jack's PhD/Chapter 3. Future shark FD/Analyses/Final paper R codes/data/AquaMaps/FD_RCP45.RData")
...
save(final_map_df_RCP45, file = "C:/Users/2022207/Dropbox/Jack's PhD/Chapter 3. Future shark FD/Analyses/Final paper R codes/data/AquaMaps/FD_RCP45_map_df.RData")
...
save(RCP45_ext_Occ_map, file = "C:/Users/2022207/Dropbox/Jack's PhD/Chapter 3. Future shark FD/Analyses/Final paper R codes/data/AquaMaps/FD_RCP45_extinctions_Species_richness_map.RData")
...
# Calculate FD metrics
pcoa <- list(li = sp_faxes_coord_sharksRCP45_ext)
ax <- c("PC1", "PC2", "PC3", "PC4")
coord_d <- pcoa$li[, ax]
...
pb_test <- progress_bar$new(
  format = "  Processing test [:bar] :percent in :elapsed",
  total = nrow(baskets_sharks_weightsRCP45_ext), clear = FALSE, width = 60
)

test <- apply(baskets_sharks_weightsRCP45_ext, 1, function(x) {
  pb_test$tick()  # Update progress bar for test
  colnames(baskets_sharks_weightsRCP45_ext)[which(x == 1)]
})
...
# Step 6: Combine the list of FD metrics into a single data frame
FDindices_taxon_RCP45_extinctions_FD <- data.frame(
  Grid = grid_names, 
  sp_richn = sp_richn,
  fric = fric,
  fsp = fsp,
...
# Save dataframe
save(FDindices_taxon_RCP45_extinctions_FD, file = "C:/Users/2022207/Dropbox/Jack's PhD/Chapter 3. Future shark FD/Analyses/Final paper R codes/data/AquaMaps/FD_RCP45_extinctions.RData")
...
# Save final dataframe to be used in plotting
save(final_map_df_RCP45_extinctions, file = "C:/Users/2022207/Dropbox/Jack's PhD/Chapter 3. Future shark FD/Analyses/Final paper R codes/data/AquaMaps/FD_RCP45_extinctions_map_df.RData")
