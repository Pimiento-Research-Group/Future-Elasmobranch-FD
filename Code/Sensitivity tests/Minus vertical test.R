###############################################################################################################
# Sensitivity tests 2: Minus vertical
...
traits <- data %>% 
  select(Species,habitat,terrestriality,thermo,feeding,
...
sharks_traits_cat <- tibble(trait_name = c("habitat","terrestriality","thermo","feeding",
                                           "diet","max.length","deepwater","body.plan","reproduction"),
                            trait_type = c("N", "O", "O", "O", "N", "Q", "N", "N", "N"))
...
FDmetrics_taxonvar.vertical<- res_df %>% 
  select(Scenario:fun)
save(FDmetrics_taxonvar.vertical,file = "C:/Users/Jack Cooper/Documents/iucn/iucn_sim/Robustness tests/Minus_vertical/CritE_full_buffer.RData")

FDmetrics_long_TaxonVar.vertical<- melt(FDmetrics_taxonvar.vertical, id.vars= "Scenario")
save(FDmetrics_long_TaxonVar.vertical,file = "C:/Users/Jack Cooper/Documents/iucn/iucn_sim/Robustness tests/Minus_vertical/CritE_full_long_buffer.RData")
