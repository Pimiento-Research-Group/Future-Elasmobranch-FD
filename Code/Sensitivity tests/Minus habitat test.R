###############################################################################################################
# Sensitivity tests 1: Minus habitat
...
traits <- data %>% 
  select(Species,vertical,terrestriality,thermo,feeding,
...
sharks_traits_cat <- tibble(trait_name = c("vertical","terrestriality","thermo","feeding",
                                           "diet","max.length","deepwater","body.plan","reproduction"),
...
FDmetrics_taxonvar.habitat<- res_df %>% 
  select(Scenario:fun)
save(FDmetrics_taxonvar.habitat,file = "C:/Users/Jack Cooper/Documents/iucn/iucn_sim/Robustness tests/Minus_habitat/CritE_full_buffer.RData")

FDmetrics_long_TaxonVar.habitat<- melt(FDmetrics_taxonvar.habitat, id.vars= "Scenario")
save(FDmetrics_long_TaxonVar.habitat,file = "C:/Users/Jack Cooper/Documents/iucn/iucn_sim/Robustness tests/Minus_habitat/CritE_full_long_buffer.RData")
