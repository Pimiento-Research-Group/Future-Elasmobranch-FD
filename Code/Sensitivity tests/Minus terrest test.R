###############################################################################################################
# Sensitivity tests 3: Minus terrestriality
...
traits <- data %>% 
  select(Species,habitat,vertical,thermo,feeding,
...
sharks_traits_cat <- tibble(trait_name = c("habitat","vertical","thermo","feeding",
                                           "diet","max.length","deepwater","body.plan","reproduction"),
...
FDmetrics_taxonvar.terrest<- res_df %>% 
  select(Scenario:fun)
save(FDmetrics_taxonvar.terrest,file = "C:/Users/Jack Cooper/Documents/iucn/iucn_sim/Robustness tests/Minus_terrest/CritE_full_buffer.RData")

FDmetrics_long_TaxonVar.terrest<- melt(FDmetrics_taxonvar.terrest, id.vars= "Scenario")
save(FDmetrics_long_TaxonVar.terrest,file = "C:/Users/Jack Cooper/Documents/iucn/iucn_sim/Robustness tests/Minus_terrest/CritE_full_long_buffer.RData")
