###############################################################################################################
# Sensitivity tests 4: Minus thermo
...
traits <- data %>% 
  select(Species,habitat,vertical,terrestriality,feeding,
...
sharks_traits_cat <- tibble(trait_name = c("habitat","vertical","terrestriality","feeding",
                                           "diet","max.length","deepwater","body.plan","reproduction"),
...
FDmetrics_taxonvar.thermo<- res_df %>% 
  select(Scenario:fun)
save(FDmetrics_taxonvar.thermo,file = "C:/Users/Jack Cooper/Documents/iucn/iucn_sim/Robustness tests/Minus_thermo/CritE_full_buffer.RData")

FDmetrics_long_TaxonVar.thermo<- melt(FDmetrics_taxonvar.thermo, id.vars= "Scenario")
save(FDmetrics_long_TaxonVar.thermo,file = "C:/Users/Jack Cooper/Documents/iucn/iucn_sim/Robustness tests/Minus_thermo/CritE_full_long_buffer.RData")
