###############################################################################################################
# Sensitivity tests 9: Minus body plan
...
traits <- data %>% 
  select(Species,habitat,vertical,terrestriality,thermo,feeding,
         diet,max.length,deepwater,reproduction)
...
FDmetrics_taxonvar.bodyplan<- res_df %>% 
  select(Scenario:fun)
save(FDmetrics_taxonvar.bodyplan,file = "C:/Users/Jack Cooper/Documents/iucn/iucn_sim/Robustness tests/Minus_bodyplan/CritE_full_buffer.RData")

FDmetrics_long_TaxonVar.bodyplan<- melt(FDmetrics_taxonvar.bodyplan, id.vars= "Scenario")
save(FDmetrics_long_TaxonVar.bodyplan,file = "C:/Users/Jack Cooper/Documents/iucn/iucn_sim/Robustness tests/Minus_bodyplan/CritE_full_long_buffer.RData")
