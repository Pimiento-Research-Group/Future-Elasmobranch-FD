###############################################################################################################
# Sensitivity tests 8: Minus deepwater
...
traits <- data %>% 
  select(Species,habitat,vertical,terrestriality,thermo,feeding,
         diet,max.length,body.plan,reproduction)
...
FDmetrics_taxonvar.deepwater<- res_df %>% 
  select(Scenario:fun)
save(FDmetrics_taxonvar.deepwater,file = "C:/Users/Jack Cooper/Documents/iucn/iucn_sim/Robustness tests/Minus_deepwater/CritE_full_buffer.RData")

FDmetrics_long_TaxonVar.deepwater<- melt(FDmetrics_taxonvar.deepwater, id.vars= "Scenario")
save(FDmetrics_long_TaxonVar.deepwater,file = "C:/Users/Jack Cooper/Documents/iucn/iucn_sim/Robustness tests/Minus_deepwater/CritE_full_long_buffer.RData")
