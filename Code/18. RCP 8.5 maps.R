...
# Load RCP 8.5
load(file = "C:/Users/2022207/Dropbox/Jack's PhD/Chapter 3. Future shark FD/Analyses/Final paper R codes/data/AquaMaps/FD_RCP85_map_df.RData")
load(file = "C:/Users/2022207/Dropbox/Jack's PhD/Chapter 3. Future shark FD/Analyses/Final paper R codes/data/AquaMaps/FD_RCP85_Species_richness_map.RData")
...
save(Map_RCP85_Ab_sprich, file = "C:/Users/2022207/Dropbox/Jack's PhD/Chapter 3. Future shark FD/Analyses/Final paper R codes/data/AquaMaps/RCP85_Spp_Rich_absolute.RData")

Map_RCP85_Ab_fric <- ggplot() +
  geom_point(
...
save(Map_RCP85_Ab_fric, file = "C:/Users/2022207/Dropbox/Jack's PhD/Chapter 3. Future shark FD/Analyses/Final paper R codes/data/AquaMaps/RCP85_FRic_absolute.RData")

Map_RCP85_Ab_fun <- ggplot() +
  geom_point(
    data = merged_data_RCP85_FD,
...
save(Map_RCP85_Ab_fun, file = "C:/Users/2022207/Dropbox/Jack's PhD/Chapter 3. Future shark FD/Analyses/Final paper R codes/data/AquaMaps/RCP85_FUn_absolute.RData")

Map_RCP85_Ab_fsp <- ggplot() +
  geom_point(
    data = merged_data_RCP85_FD,
...
save(Map_RCP85_Ab_fsp, file = "C:/Users/2022207/Dropbox/Jack's PhD/Chapter 3. Future shark FD/Analyses/Final paper R codes/data/AquaMaps/RCP85_FSp_absolute.RData")
