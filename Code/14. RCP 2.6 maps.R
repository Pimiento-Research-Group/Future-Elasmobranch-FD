...
## Load RCP 2.6
load(file = "C:/Users/2022207/Dropbox/Jack's PhD/Chapter 3. Future shark FD/Analyses/Final paper R codes/data/AquaMaps/FD_RCP26_map_df.RData")
load(file = "C:/Users/2022207/Dropbox/Jack's PhD/Chapter 3. Future shark FD/Analyses/Final paper R codes/data/AquaMaps/FD_RCP26_Species_richness_map.RData")
...
## Absolute changes maps - alter based on new highest and lowest values
...
save(Map_RCP26_Ab_sprich, file = "C:/Users/2022207/Dropbox/Jack's PhD/Chapter 3. Future shark FD/Analyses/Final paper R codes/data/AquaMaps/RCP26_Spp_Rich_absolute.RData")

Map_RCP26_Ab_fric <- ggplot() +
  geom_point(
...
save(Map_RCP26_Ab_fric, file = "C:/Users/2022207/Dropbox/Jack's PhD/Chapter 3. Future shark FD/Analyses/Final paper R codes/data/AquaMaps/RCP26_FRic_absolute.RData")

Map_RCP26_Ab_fun <- ggplot() +
  geom_point(
    data = merged_data_RCP26_FD,
...
save(Map_RCP26_Ab_fun, file = "C:/Users/2022207/Dropbox/Jack's PhD/Chapter 3. Future shark FD/Analyses/Final paper R codes/data/AquaMaps/RCP26_FUn_absolute.RData")

Map_RCP26_Ab_fsp <- ggplot() +
  geom_point(
    data = merged_data_RCP26_FD,
...
save(Map_RCP26_Ab_fsp, file = "C:/Users/2022207/Dropbox/Jack's PhD/Chapter 3. Future shark FD/Analyses/Final paper R codes/data/AquaMaps/RCP26_FSp_absolute.RData")
