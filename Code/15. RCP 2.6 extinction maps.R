...
load(file = "C:/Users/2022207/Dropbox/Jack's PhD/Chapter 3. Future shark FD/Analyses/Final paper R codes/data/AquaMaps/FD_RCP26_extinctions_map_df.RData")
load(file = "C:/Users/2022207/Dropbox/Jack's PhD/Chapter 3. Future shark FD/Analyses/Final paper R codes/data/AquaMaps/FD_RCP26_extinctions_Species_richness_map.RData")
...
FRic_shift_summary <- merged_data_RCP26ext_FD %>%
  group_by(FRic_Shift) %>%
  summarise(Count = n()) %>%
  mutate(Percentage = (Count / sum(Count)) * 100)

# Calculate percentages for FUn_Shift
FUn_shift_summary <- merged_data_RCP26ext_FD %>%
  group_by(FUn_Shift) %>%
  summarise(Count = n()) %>%
  mutate(Percentage = (Count / sum(Count)) * 100)

# Calculate percentages for FSp_Shift
FSp_shift_summary <- merged_data_RCP26ext_FD %>%
  group_by(FSp_Shift) %>%
  summarise(Count = n()) %>%
  mutate(Percentage = (Count / sum(Count)) * 100)
...
save(Map_RCP26ext_Ab_sprich, file = "C:/Users/2022207/Dropbox/Jack's PhD/Chapter 3. Future shark FD/Analyses/Final paper R codes/data/AquaMaps/RCP26ext_Spp_Rich_absolute.RData")

Map_RCP26ext_Ab_fric <- ggplot() +
  geom_point(
...
save(Map_RCP26ext_Ab_fric, file = "C:/Users/2022207/Dropbox/Jack's PhD/Chapter 3. Future shark FD/Analyses/Final paper R codes/data/AquaMaps/RCP26ext_FRic_absolute.RData")

Map_RCP26ext_Ab_fun <- ggplot() +
  geom_point(
    data = merged_data_RCP26ext_FD,
...
save(Map_RCP26ext_Ab_fun, file = "C:/Users/2022207/Dropbox/Jack's PhD/Chapter 3. Future shark FD/Analyses/Final paper R codes/data/AquaMaps/RCP26ext_FUn_absolute.RData")

Map_RCP26ext_Ab_fsp <- ggplot() +
  geom_point(
    data = merged_data_RCP26ext_FD,
...
save(Map_RCP26ext_Ab_fsp, file = "C:/Users/2022207/Dropbox/Jack's PhD/Chapter 3. Future shark FD/Analyses/Final paper R codes/data/AquaMaps/RCP26ext_FSp_absolute.RData")
