...
save(RCP26_Occ_map, file = "C:/Users/2022207/Dropbox/Jack's PhD/Chapter 3. Future shark FD/Analyses/Final paper R codes/data/AquaMaps/FD_RCP26_Species_richness_map.RData")
...
pcoa <- list(li = sp_faxes_coord_sharksRCP26)
...
test <- apply(baskets_sharks_weightsRCP26, 1, function(x) {
...
FDindices_taxon_RCP26_FD <- data.frame(
  Grid = grid_names, 
  sp_richn = sp_richn,
  fric = fric,
  fsp = fsp,
...
# Save dataframe
save(FDindices_taxon_RCP26_FD, file = "C:/Users/2022207/Dropbox/Jack's PhD/Chapter 3. Future shark FD/Analyses/Final paper R codes/data/AquaMaps/FD_RCP26.RData")
...
save(final_map_df_RCP26, file = "C:/Users/2022207/Dropbox/Jack's PhD/Chapter 3. Future shark FD/Analyses/Final paper R codes/data/AquaMaps/FD_RCP26_map_df.RData")
...
save(RCP26_ext_Occ_map, file = "C:/Users/2022207/Dropbox/Jack's PhD/Chapter 3. Future shark FD/Analyses/Final paper R codes/data/AquaMaps/FD_RCP26_extinctions_Species_richness_map.RData")
...
# Calculate FD metrics
pcoa <- list(li = sp_faxes_coord_sharksRCP26_ext)
ax <- c("PC1", "PC2", "PC3", "PC4")
coord_d <- pcoa$li[, ax]
...
pb_test <- progress_bar$new(
  format = "  Processing test [:bar] :percent in :elapsed",
  total = nrow(baskets_sharks_weightsRCP26_ext), clear = FALSE, width = 60
)

test <- apply(baskets_sharks_weightsRCP26_ext, 1, function(x) {
  pb_test$tick()  # Update progress bar for test
  colnames(baskets_sharks_weightsRCP26_ext)[which(x == 1)]
})
...
# Step 6: Combine the list of FD metrics into a single data frame
FDindices_taxon_RCP26_extinctions_FD <- data.frame(
  Grid = grid_names, 
  sp_richn = sp_richn,
  fric = fric,
  fsp = fsp,
...
# Save dataframe
save(FDindices_taxon_RCP26_extinctions_FD, file = "C:/Users/2022207/Dropbox/Jack's PhD/Chapter 3. Future shark FD/Analyses/Final paper R codes/data/AquaMaps/FD_RCP26_extinctions.RData")
...
# Save final dataframe to be used in plotting
save(final_map_df_RCP26_extinctions, file = "C:/Users/2022207/Dropbox/Jack's PhD/Chapter 3. Future shark FD/Analyses/Final paper R codes/data/AquaMaps/FD_RCP26_extinctions_map_df.RData")
